    ...
    <div class="form">
        <form id="myForm" style="height: 483px;" method="post">
            <div>
                ...
                <select name="division" id="hq" class="form-control">
                    <option selected disabled>Choose here</option>
                    <option value="<?php echo $res['DIVISION']; ?>" selected><?php echo $res['UNIT_DESC']; ?></option>
                </select>
            </div>

            <div>
                <label for="section">Section</label><br>
                <select name="section" id="sec" class="form-control">
                    <option value="<?php echo $res['SECTIONCODE']; ?>" selected disabled><?php echo $res['SECTIONCODE']; ?></option>
                </select>
            </div>
